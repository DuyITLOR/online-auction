...
import { SubmitButton } from '../../libs/actions/SubmitButton';
    ...
    <div className='min-h-screen flex items-center'>
      <form action={action} className='w-[450px] mx-auto'>
        ...
        <div className='font-semibold mt-3 text-teal-700 text-center'>
          Tạo tài khoản trên nền tảng SnapBid
        </div>
        ...
        <div className='flex flex-col gap-6 bg-slate-200 shadow-md rounded-md mt-7 py-7 px-5'>
          ...
          {/* <Button className='bg-teal-600 text-white font-bold mt-2 hover:opacity-80'>
            Đăng ký
          </Button> */}
          <SubmitButton />
          ...
          <div className='flex items-center gap-1 justify-center'>
            <p className='font-semibold text-sm'>
              Bạn đã có tài khoản SnapBid rồi?{' '}
            </p>
            <a
              href='/auth/signin'
